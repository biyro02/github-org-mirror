...
EOF
    ...
    echo "    Edit GITHUB_TOKEN and GITHUB_ORG, then press Enter to continue."
...
# Install systemd service (adjust paths to INSTALL_DIR)
...
# Add hourly cron
(crontab -l 2>/dev/null | grep -v "github-org-mirror/mirror-sync"; \
...
echo ""
echo "  Mirrors are in: $INSTALL_DIR/repos/"
